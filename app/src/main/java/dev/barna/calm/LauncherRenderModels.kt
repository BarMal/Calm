...
class LauncherRenderModelFactory(
    ...
    fun create(
        ...
        classicGridConfig: ClassicGridConfig = ClassicGridConfig(),
...
data class LauncherRenderModel(
    ...
    val classicPages: List<ClassicLauncherPageDefinition> = emptyList(),
    val classicGridConfig: ClassicGridConfig = ClassicGridConfig(),
